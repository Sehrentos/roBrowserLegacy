...
define(function (/** @type {Require} */require) {
	...
	/** @type {Preferences.Camera} */var Preferences = require('Preferences/Camera');
	 ...
	 * @param {number} xAmt axis amount
	 * @param {number} yAmt axis amount
	 * @param {number} zAmt axis amount
	 */
