...
define(['./GameFileDecrypt', 'Utils/BinaryReader', 'Utils/Struct', 'Utils/Inflate'], function (
	/** @type {Loaders.GameFileDecrypt} */GameFileDecrypt,
	/** @type {Utils.BinaryReader} */BinaryReader,
	/** @type {Utils.Struct} */Struct,
	/** @type {Utils.Inflate} */Inflate
) {
	'use strict';
	...
	GRF.prototype.load = function Load(file) {
		...
		// @ts-ignore Helper (ignore vendor specifics)
	 ...
	 *
	 * @param {Uint8Array} out content table
	 ...
	 *
	 * @param {object} a entry 1
	 * @param {object} b entry 2
	 */
