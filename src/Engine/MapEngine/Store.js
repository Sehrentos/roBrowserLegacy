 ...
 */
define(/** @type {(require: Require)=>Engine.MapEngine.Store} */function (require) {
	'use strict';
	...
	/** @type {UI.Component.NpcStore} */var NpcStore = require('UI/Components/NpcStore/NpcStore');
	/** @type {UI.Component.Vending} */var Vending = require('UI/Components/Vending/Vending');
	/** @type {UI.Component.VendingShop} */var VendingShop = require('UI/Components/VendingShop/VendingShop');
