...
function(
	...
	/** @type {Core.MemoryManager} */Memory,
	/** @type {Utils.glMatrix} */glMatrix,
	/** @type {Engine.SessionStorage} */Session
) {
	'use strict';
	 ...
	 *
	 * @param {string} filename optional to stop
	 */
	 ...
	 *
	 * @param {number} maxConst instance const value
	 */
