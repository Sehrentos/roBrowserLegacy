 ...
 */
define(/** @type {(require: Require)=>Engine.MapEngine.Pet} */function (require) {
	'use strict';
	...
	/** @type {UI.Component.SlotMachine} */var SlotMachine = require('UI/Components/SlotMachine/SlotMachine');
