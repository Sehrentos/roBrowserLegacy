 ...
 */
define(/** @type {(require: Require)=>Engine.MapEngine.MapState} */function (require) {
	'use strict';

	/** @type {DB.Map.MapState} */var MapState = require('DB/Map/MapState');
	...
	/**
	 * Initialize
	 * @type {Engine.MapEngine.MapState}
	 */
