 ...
 */
define(/** @type {(require: Require)=>Engine.MapEngine.Bank} */function (require) {
	'use strict';
	...
	/** @type {UI.UIManager} */var Bank = require('UI/Components/Bank/Bank');
	/** @type {UI.Component.ChatBox} */var ChatBox = require('UI/Components/ChatBox/ChatBox');

	/**
	 * Engine namespace
	 * type {Engine.MapEngine.Bank}
	 */
	var BankEngine = {};
